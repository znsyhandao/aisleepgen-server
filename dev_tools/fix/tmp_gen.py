...
gen = get_tts_wav(ref_wav_path='raw_audio/sliced_caizhi/gongsheng_0000.wav', prompt_text=text, prompt_language='\u4e2d\u6587', text=text, text_language='\u4e2d\u6587', top_k=5, top_p=0.8, temperature=0.8)
